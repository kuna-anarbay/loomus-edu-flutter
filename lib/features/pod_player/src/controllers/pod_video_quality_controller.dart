...
class _PodVideoQualityController extends PodVideoController {
  ///
  int? vimeoPlayingVideoQuality;

  ///vimeo all quality urls
  List<VideoQualityUrl> vimeoOrVideoUrls = [];
  ...
  VideoQualityUrl getQualityUrl(int quality) {
  ...
  Future<String> getUrlFromVideoQualityUrls({
    ...
    VideoQualityUrl? urlWithQuality;
  ...
  Future<List<VideoQualityUrl>> getVideoQualityUrlsFromYoutube(
